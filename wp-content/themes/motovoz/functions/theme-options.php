...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      ...
      array(
        'id'          => 'autopark',
        'title'       => 'Страница автопарк'
        ),
      array(
        'id'          => 'partners',
        'title'       => 'Страница партнеры'
        ),
      array(
        'id'          => 'faq',
        'title'       => 'Страница faq'
    ...
    'settings'        => array( 
      ...
      array(
       ...
       array(
        'id'          => 'form-onlain',
        'label'       => 'Форма',
        'desc'        => 'Добавьте в это поле шорткод из Contact Form 7',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'home',
      ),
      ...
      array(
        'id'          => 'service-text-bottom',
        'label'       => 'Текст внизу страницы',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textarea-simple',
        'section'     => 'service',
      ...
      array(
        'id'          => 'service-contact-top',
        'label'       => 'Контактная информация (верхняя)',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'service'
      ),
      array(
        'id'          => 'service-adress-top',
        'label'       => 'Адрес',
        'desc'        => '',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
       ...
       array(
        'id'          => 'service-contact-bottom',
        'label'       => 'Контактная информация (внизу)',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'service'
      ),
      array(
        'id'          => 'service-adress-bottom',
        'label'       => 'Адрес',
        'desc'        => '',
        'std'         => '',
        'type'        => 'text',
